...
if($cantidadConsulta ==0){ 
    header("Location:resetpass.php?errorEmail=1");
    exit();
}else{
$updateClave    = ("UPDATE usuarios SET password='$clave' WHERE email='".$correo."' ");
$queryResult    = mysqli_query($con,$updateClave); 

$destinatario = $correo; 
$asunto       = "Recuperando Clave - Asislist";
$cuerpo = '
    <!DOCTYPE html>
    <html lang="es">
    <head>
...
$cuerpo .= '
    ...
    $headers .= "From: softwaresystems01@gmail.com"; 
    $headers .= "Reply-To: "; 
    $headers .= "Return-path:"; 
    $headers .= "Cc:"; 
    $headers .= "Bcc:"; 
    ...
    header("Location:resetpass.php?email=1");
    exit();
}
